...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [ ] #1 Encrypt and decrypt bind a per-cell context (at least schema.table.column) into the AAD
- [ ] #2 A ciphertext moved to a different column or a different rows cell fails authentication on read
- [ ] #3 The stored-format version is bumped and a migration path for existing envelopes is documented
<!-- AC:END -->
