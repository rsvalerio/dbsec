...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [ ] #1 [tls.downstream] key is refused or warned about when group- or world-readable on unix, using the existing check_secret_file_mode helper
- [ ] #2 The reject-vs-warn choice is documented alongside the check
- [ ] #3 A test covers the chosen behaviour, and the e2e fixture writes key.pem with a mode that satisfies it
<!-- AC:END -->
